...
public class AdminAppConstant {
    ...
    public static final String LOAN_IS_LESS = "Loan return amount is more than total loan";
    public static final String TRANSACTION_NOT_FOUND = "No transaction found for the %s : %d";
